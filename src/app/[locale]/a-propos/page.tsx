                  ...
                  <motion.div key={index} variants={itemVariants}>
                    ...
                    >
                      <CardContent className="p-6">
                        ...
                        <h3 className="text-lg font-semibold font-[family-name:var(--font-display)] text-foreground mb-3">
                ...
                >
                  ...
                  <Card className="border-card-border bg-card h-full rounded-xl">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-xl font-semibold font-[family-name:var(--font-display)] text-foreground mb-4">
                        {phase.title}
                      </h3>
